...
<template>
  <div class="wrapper">
    <el-dialog :visible="show" title="选择优惠券" fullscreen @close="closeDialog">
      <span slot="title" class="title">消息模版</span>
      <main class="tableMainContent">
        ...
        <div class="right">
          <el-form ref="form" :model="form" label-width="160px" class="form">
            ...
            <el-form-item label="消息模版详情链接" prop="link">
...
export default {
  ...
  methods: {
    ...
    verify() {
      ...
      const verifyRules = [
        [len > 180, '模版内容不能超过150个字符'],
        [this.form.title === '', '模版消息标题尚未填写'],
        [this.form.title.length >= 15, '模版消息标题不得超过15个字符'],
