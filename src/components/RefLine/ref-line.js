...
for (const p in lines) {
  ...
  // 虚线的间隙大小修改 background-size 即可
  node.style.cssText = `display:none;opacity:0.7;position:absolute;background-color:#777;background-size:16px 16px;z-index:199111250;${p[0] === 'x'
    ? 'width:100%;height:1px;left:0;background-image: linear-gradient(90deg,rgba(255,255,255,1) 25%,transparent 25%,transparent 50%,rgba(255,255,255,1) 50%,rgba(255,255,255,1) 75%,transparent 75%,transparent);'
    : 'width:1px;height:100%;top:0;background-image: linear-gradient(0,rgba(255,255,255,1) 25%,transparent 25%,transparent 50%,rgba(255,255,255,1) 50%,rgba(255,255,255,1) 75%,transparent 75%,transparent);'}`
