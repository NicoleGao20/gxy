<template>
  <div>
    ...
    <el-form-item
      ...
      <el-input v-model="startValue" :disabled="filterCombine.onlyRead" :placeholder="operator === '$'?'起始值':'值'" @change="changeSpecItem" clearable/>
    </el-form-item>
    <el-form-item
      v-if="operator === '$'"
      :prop="prefixProp+'.column_value'"
      ...
      label-width="20px"
      style="display: inline-block;width: 180px;">
      <el-input v-model="endValue" :disabled="filterCombine.onlyRead" placeholder="截止值" @change="changeSpecItem" clearable/>
    </el-form-item>
  </div>
</template>
<script>
