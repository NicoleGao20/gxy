      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
          ...
          <el-row :gutter="20">
            <el-col :span="8">
              <el-form-item label="条件类目" prop="label_class_def_id">
                <el-input v-model="form.label_class_def_id" disabled clearable/>
              </el-form-item>
            </el-col>
            <el-col :span="8">
        ...
        <div class="basic-info">
          ...
          <el-row :gutter="20" style="padding-left: 10px;margin-top: 10px;">
            <el-col :span="24">
              <!-- <el-button type="primary" :disabled="actionType == 'add'" @click="addLable">新增</el-button> -->
              <el-table :data="form.rule_list" style="margin-top: 10px;">
                <!-- <el-table-column label="序号" type="index"/> -->
                <el-table-column prop="label_value" property="content" label="标签内容" width="400"/>
        ...
        <el-dialog :visible.sync="openFilterModal" title="条件值设置" width="900px">
          <el-form v-if="openFilterModal" ref="curRuleRow" :model="curRow" label-width="100px">
            <el-form-item
              :rules="{
                required: true, message: '请填写条件内容', trigger: 'change'
              }"
              prop="label_value"
              label="条件内容">
          ...
          <rule-filter v-if="openFilterModal" ref="ruleFilter" :rule-value="curRow.label_rule" :brand_code="form.brand_code" :id="form.id" :label_value="curRow.label_value" :only-read="readOnly" application-type="rule_label"/>
...
<script>
import { getComplexBrandLabel, getClassTree, editComplexBrandLabel } from '@/api/brandLabelPool'
