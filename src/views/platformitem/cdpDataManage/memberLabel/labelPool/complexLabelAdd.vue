<template>
  <div class="page-container">
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
          ...
          <el-row :gutter="20">
            <el-col :span="8">
              <el-form-item label="更新频次">
                <el-select v-model="form.update_frequency" disabled style="width: 100%;">
              ...
              <el-table :data="form.rule_list" style="margin-top: 10px;">
                ...
                <el-table-column label="操作">
                  <template slot-scope="scope">
                    ...
                    <el-button :disabled="$route.query.view === 'true' || (scope.row.id && getBrand_info.length > 0)" type="text" @click="del(scope.$index)">删除</el-button>
                  </template>
                </el-table-column>
              </el-table>
            </el-col>
        ...
        <div class="basic-info" style="margin-top: 20px;">
          ...
          <div style="margin-top: 10px;padding-left: 10px;">
            <el-button :disabled="!form.rule_list.length > 0 || $route.query.view === 'true' || isTimeOut" type="primary" @click="choseBrand">选择品牌</el-button>
    ...
    <el-dialog :visible.sync="openFilterModal" :close-on-click-modal="false" title="条件值设置" width="900px">
      ...
      <rule-filter v-if="openFilterModal" ref="ruleFilter" :rule-value="curRow.label_rule" :hidden-people-counts="true" :only-read="readOnly" application-type="complex_label"/>
...
import { getComplexLabel, addComplexLabel, editComplexLabel } from '@/api/labelPool'
  ...
  methods: {
    ...
    init() {
      if (!this.$route.query.id) {
        ...
        getComplexLabel({ id: this.$route.query.id, create_type: this.$route.query.create_type })
          .then((res) => {
            var data = res.data
            if (data) {
    ...
    confirmHandler() {
      ...
      this.$refs['form'].validate((valid) => {
        ...
        if (this.$route.query.id) {
          ...
          editComplexLabel(params).then((res) => {
          ...
          addComplexLabel(params).then((res) => {
            this.actionLoading = false
            this.$message({
              message: '保存成功!',
              type: 'success',
