  ...
  <div class="page-container-gap">
    <header style="padding: 10px">
      <el-tabs v-model="activeName" @tab-click="handleClick">
         <el-tab-pane label="价值模型" name="userValue" :lazy="true">
        <userValue/>
        </el-tab-pane>
        <el-tab-pane label="分层模型" name="hierarchy" :lazy="true">
        <hierarchy/>
        </el-tab-pane>
        <el-tab-pane label="预测模型" name="forecast" :lazy="true">
        <forecast/>
        </el-tab-pane>
      </el-tabs>
    </header>
...
export default {
  name: 'userModel',
  components: { forecast,userValue,hierarchy},
  data() {
    return {
      activeName: "userValue",
    };
  },
  methods: {
