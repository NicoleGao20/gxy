<template>
  <div class="page-container">
        ...
        <el-form-item
          ...
          <el-table
            ...
            <el-table-column
              ...
              prop="column_type"/>
            <el-table-column
              v-if="form.table_type==='dimension'"
              label="升级为标签"
              prop="is_uptolabel">
            ...
            <!-- <el-table-column
              v-if="form.table_type==='dimension' && isEdit"
              label="是否升级属性"
              width="120">
              <template slot-scope="scope">
            ...
            <!-- <el-table-column
              ...
              align="left">
              <template slot-scope="scope">
                <el-button v-if="scope.row.is_uptolabel ==='N'" type="primary" plain @click="setLabel(scope.row)"> 设置为标签 </el-button>
                <el-button v-if="scope.row.is_uptolabel ==='Y'" type="primary" plain @click="setLabel(scope.row)"> 设置为属性 </el-button>
                <el-button v-if="scope.row.is_visible==='Y'" type="primary" plain @click="setVisible(scope.row)">设置为不可见</el-button>
                <el-button v-if="scope.row.is_visible==='N'" type="primary" plain @click="setVisible(scope.row)">设置为可见</el-button>
              </template>
            </el-table-column> -->
          </el-table>
        </el-form-item>
    ...
    <div :style="{left: sidebar.opened?'230px': '50px'}" class="action-wrap">
      <el-button @click="$router.push({ name: 'conditionLibrary'})">返回</el-button>
    </div>
    <el-dialog
