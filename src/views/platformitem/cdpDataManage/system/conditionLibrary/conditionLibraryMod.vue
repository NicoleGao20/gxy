<template>
  <div class="page-container">
    <div style="padding-bottom: 50px;">
          ...
          <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                ...
                <!-- <el-button v-if="scope.row.is_visible==='Y'&&scope.row.is_uptolabel ==='Y'" type="primary" plain @click="setVisible(scope.row)">设置为不可见</el-button> -->
                <!-- <el-button v-if="scope.row.is_visible==='N'&&scope.row.is_uptolabel ==='Y'" type="primary" plain @click="setVisible(scope.row)">设置为可见</el-button> -->
              </template>
            </el-table-column>
          </el-table>
        </el-form-item>
      ...
      <div class="tips">
        <p>设置为条件：将标签升级为筛选器中条件，升级后可以下发到各个品牌。</p>
        <p>取消条件：将标签取消做为筛选器中条件，取消判断是否被使用。</p>
