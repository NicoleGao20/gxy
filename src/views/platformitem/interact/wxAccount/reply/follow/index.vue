      ...
      <el-row :gutter="30"  v-loading="loading">
        <el-col v-bind="grid" class="acea-row">
          <div class="left mb15 ml40">
            <img class="top" src="@/assets/img/mobilehead.png">
            <img class="bottom" src="@/assets/img/mobilefoot.png">
            <div class="centent">
              <div class="time-wrapper"><span class="time">9:36</span></div>
              <div v-if="formValidate.type !== 'news'" class="view-item text-box clearfix">
                <div class="avatar fl"><img src="@/assets/img/head.gif"></div>
              ...
              <div v-if="formValidate.type === 'news'">
                <div class="newsBox">
                  <!--<div class="news_pic mb15" style="backgroundImage: url('@/assets/img/mobilefoot.png');backgroundSize:'100% 100%'}" />-->
...
import { replySaveApi, replyEditApi, replyInfoApi, replyListApi, keywordsInfoApi, replyUpdateApi } from '@/api/markting/coupon/wxApi'
import { wechatUploadApi } from '@/api/markting/coupon/systemSetting'
export default {
  name: 'Index',
  components: { },
  data() {
