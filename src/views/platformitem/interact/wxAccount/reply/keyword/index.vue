        ...
        <div class="container">
          <el-form :inline="true" size="small">
            <el-form-item label="回复类型：">
              <el-select v-model="tableFrom.type" placeholder="请选择类型" class="selWidth" @change="seachList">
      ...
      >
        ...
        <el-table-column label="操作" min-width="100">
          <template slot-scope="scope">
            ...
            <el-button type="text" class="deleteFontColor" @click="handleDelete(scope.row.id, scope.$index)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <div class="block">
...
<script>
import { replyListApi, replyDeleteApi, replyUpdateApi } from '@/api/markting/coupon/wxApi'
