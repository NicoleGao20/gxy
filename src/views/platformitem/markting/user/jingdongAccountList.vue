  ...
  <div class="page-container-gap">
    ...
    <main style="padding: 20px">
      ...
      >
        ...
        <el-table-column prop="customerPin" label="PIN" width="200" />
        <el-table-column prop="levelAtJd" label="京东等级" width="110" />
        <el-table-column prop="tradeCount" label="交易笔数" width="110" />
        <el-table-column prop="tradeAmount" label="交易金额" width="110" />
        <el-table-column prop="sphone" label="首次购买手机号" width="110" />
        <el-table-column prop="rphone" label="最近购买手机号" width="110" />
        <el-table-column prop="lastOrderDate" label="最后交易时间" width="200" />
      ...
      tableData: [
        {
          ...
          venderId: "123456",
          customerPin: "test",
          lastOrderDate: "2019-02-14 11:33:35",
          tradeAmount: "1",
          levelAtJd: "21321",
          levelAtShop: "1",
          bphone: "",
