  ...
  <div class="page-container-gap">
    ...
    <main style="padding: 20px">
      ...
      >
        ...
        <el-table-column prop="union_id" label="union_id" width="200" />
...
export default {
  ...
  data() {
    return {
      ...
      tableData: [
        {
          avatar: "http://thirdwx.qlogo.cn/mmopen/iawMnhMqlTItWpTUibib80a34TgFNib0j7eCdWzZJKqj1UsJpia6xXuNHP5MjcdQCMXbTISEibx4zzZ0toQXduudXzlH8LwNdGhMDI/132",
          city: "上海",
          country: "中国",
          gender: "男",
          nickname: "张伟",
