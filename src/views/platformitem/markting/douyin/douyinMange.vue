  ...
  <div class="page-container-gap">
    <header style="padding: 10px">
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="抖音群发" name="douyinSends" :lazy="true">
        <douyinSends/>
        </el-tab-pane>
        <el-tab-pane label="发送日志" name="douyinsendlog" :lazy="true">
        <douyinsendlog/>
        </el-tab-pane>
      </el-tabs>
    </header>
...
<script>
import douyinSends from "./douyinSends"
import douyinsendlog from "./douyinsendlog"
export default {
  name: 'emailMange',
  components: { douyinSends,douyinsendlog},
  data() {
    return {
      activeName: "douyinSends",
    };
  },
  methods: {
