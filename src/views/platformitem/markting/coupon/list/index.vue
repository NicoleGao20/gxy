  ...
  <div class="divBox">
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        ...
        <router-link :to="{name:'creatCoupon'}">
...
<script>
  import { marketingListApi, couponIssueStatusApi, couponUserListApi } from '@/api/markting/coupon/marketing'
  import { roterPre } from '@/api/markting/coupon/settings'
  export default {
    name: 'CouponList',
    data() {
      return {
