...
export default {
  ...
  created() {
    if (this.$route.name === 'newpinyou') this.mode = 'new'
    if (this.$route.name === 'editpinyou') this.mode = 'edit'
    if (this.$route.name === 'viewpinyou') this.mode = 'view'
    if (this.mode !== 'new') {
