<template>
  <div class="jing-dong-shu-fang-container">
      ...
      <el-form label-position="right" label-width="100px">
        ...
        <el-col :span="6">
          <el-form-item label="推送状态:">
            <el-select v-model="searchForm.ads_push_status" style="width: 100%;margin-bottom: 10px;" filterable placeholder="请选择" :filter-method="getInfo" @focus="getInfo">
              <el-option
    ...
    <main class="tableMainContent">
      <router-link :to="{name:'newJingdongShufang'}"><el-button type="primary" class="mb10">新增</el-button></router-link>
      <el-table
        v-loading="loading"
        stripe
        :data="tableData"
...
export default {
  ...
  methods: {
    ...
    getInfo(){
      console.log(this.searchForm,'searchForm.ads_push_status')
    },
    filterData() {
      this.params.page = 1;
      this.initData();
