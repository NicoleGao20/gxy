...
<script>
// import belleSendingSms from '@/privatemodules/belle-sending-sms'
  ...
  data() {
    ...
    return {
      ...
      nodeConf: {
        ...
        filterDayCnt: (this.curComConfig.nodeConf.node_data && this.curComConfig.nodeConf.node_data.filterDayCnt) || '',
