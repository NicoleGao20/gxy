<template>
  <div class="page-container-gap">
    ...
    <main class="tableMainContent">
      <router-link :to="{name:'emailGroupSendsAdd'}"><el-button type="primary" class="listAddBtnStyle">新增</el-button></router-link>
      <el-table
        v-loading="loading"
        stripe
        :data="tableData"
      ...
      >
        ...
        <el-table-column prop="col2" label="邮件标题" width="110" />
        <el-table-column prop="col3" label="发送数" width="80" />
        <el-table-column prop="col4" label="成功数" width="80" />
        <el-table-column prop="col5" label="失败数" width="80" />
        <el-table-column prop="col6" label="邮件地址" width="140" />
        <el-table-column prop="col7" label="发送类型" width="200" />
        <el-table-column prop="col8" label="状态" width="110" />
        <el-table-column prop="col9" label="邮件平台" width="200" />
        <el-table-column prop="col10" label="发送时间" width="140" />
