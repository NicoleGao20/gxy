  ...
  <div class="page-container-gap">
    <header style="padding: 10px">
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="邮件群发" name="first" :lazy="true">
        <emailGroupSends/>
        </el-tab-pane>
        <el-tab-pane label="邮件日志" name="second" :lazy="true">
        <emailsendlog/>
        </el-tab-pane>
      </el-tabs>
    </header>
...
<script>
import emailGroupSends from "./emailGroupSends"
import emailsendlog from "./emailsendlog"
export default {
  name: 'emailMange',
  components: { emailGroupSends,emailsendlog},
  data() {
    return {
      activeName: "first",
    };
