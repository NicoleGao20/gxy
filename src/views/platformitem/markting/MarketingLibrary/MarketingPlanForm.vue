  ...
  <my-wrapper
    ...
    <template v-slot:extra>
      <el-row :gutter="14">
        <el-col :span="16">
          <my-detail :column="2">
            <el-form-item label="创建人">曲丽丽</el-form-item >
            <el-form-item label="订购产品">XX 服务</el-form-item >
            <el-form-item label="创建时间">2017-07-07</el-form-item >
            <el-form-item label="关联单据">12421</el-form-item >
            <el-form-item label="生效日期">2017-07-07 ~ 2017-08-08</el-form-item >
            <el-form-item label="备注">请于两个工作日内确认</el-form-item >
          </my-detail>
        </el-col>
    ...
    <my-panel title="用户信息" shadow="never" :border="false" theme="border-left">
      <my-detail :column="{xxl:4,xl:3,lg:2,md:2,sm:2,xs:1}">
        <el-form-item label="用户姓名">付小小</el-form-item >
        <el-form-item label="联系电话">18100000000</el-form-item >
        <el-form-item label="常用快递">菜鸟仓储</el-form-item >
        <el-form-item label="取货地址">取货地址浙江省杭州市西湖区万塘路18号</el-form-item >
