  ...
  <div class="page-container-gap">
    <section>
      <header>
        <el-form ref="form" :model="searchForm" :rules="rules" label-position="right" label-width="80px">
          ...
          <el-row :gutter="20">
            <el-col :span="8">
              <el-form-item label="受众名称" prop="group_name">
                <el-input :disabled="typeEdit" v-model.trim="searchForm.group_name" maxlength="50" clearable/>
              </el-form-item>
            </el-col>
            <el-col :span="8">
            ...
            <el-col :span="8">
              <el-form-item label="受众属性" prop="group_attribute">
                <el-select :disabled="typeEdit" v-model="searchForm.group_attribute" style="width: 100%;" clearable placeholder="请选择">
                  <el-option
          ...
          <el-row :gutter="20">
            <el-col :span="8">
              <el-form-item label="受众目的" prop="group_purpose">
                <el-select :disabled="typeEdit" v-model="searchForm.group_purpose" style="width: 100%;" clearable placeholder="请选择">
                  <el-option
          ...
          <FilterCombine v-if="loaded" ref="groupFilter" :rule-value="searchForm.group_rule" :only-read="readOnly" :id="searchForm.id" application-type="complex_group"/>
        </el-form>
      </header>
      <footer :style="{left: sidebar.opened?'230px': '50px'}" class="action-wrap">
        ...
        <el-button v-if="!readOnly" :loading="isLoading" type="primary" size="small" class="search-more"  @click="crowdMultitude" :before-close="handleClose">人群推送</el-button>
      </footer>
    </section>
    <!-- <el-drawer
      :visible.sync="drawer"
    ...
    <el-drawer :visible.sync="drawer" :with-header="false" size="90%">
       ...
       <el-dialog :visible.sync="dialogCrowd" title="创建推送功能" width="700px">
        <ul class="page-tool">
          <router-link :to="{name:'newJingdongShufang'}" v-for="item in dateAddedList" :key="item.id">
            <li>
              <div class="page-img">
...
import { getType } from "@/api/markting/security/visit";
...
export default {
  ...
  mounted() {
    ...
    this.typeEdit=this.$route.query.type
    this.multitude()
  },
  methods: {
    init() {
